  ...
  return (
    <section className="relative pt-20 md:pb-32 flex flex-col items-center justify-center min-h-[calc(100dvh-120px)] sm:min-h-[60vh] text-center px-4 overflow-hidden">
      ...
      <div className="mb-6 size-20 bg-black rounded-2xl flex items-center justify-center shadow-lg border border-white/10">
        <img src="/images/logo.svg" alt="Logo" className="size-12 opacity-80" />
      </div>
      ...
      <div className="flex gap-3 mb-4 h-12">
        ...
        <div className="flex gap-2">
          <div className="w-14 h-full bg-white rounded-lg flex items-center justify-center">
            <img src="/images/apple.svg" className="size-6" alt="Apple" />
          </div>
          <div className="w-14 h-full bg-white rounded-lg flex items-center justify-center">
            <img src="/images/google.svg" className="size-6" alt="Google" />
          </div>
        </div>
      </div>
      <p className="text-sm">
